...
class AccountTests: XCTestCase {
    ...
    func testCanParse() throws {
        ...
        XCTAssertEqual(result[0].createdDateTime.monthDayYearString, "jún. 21, 2010")
        ...
        XCTAssertEqual(result[1].createdDateTime.monthDayYearString, "jún. 21, 2011")
        ...
        XCTAssertEqual(account1.createdDateTime.monthDayYearString, "jún. 21, 2010")
